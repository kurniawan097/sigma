...
class Escher
{
        ...
        while ($this->pos < $this->dataSize) {
            ...
            switch ($fbt) {
                ...
                case self::BLIPJPEG:
                    ...
                    break;
                case self::BLItarif_pajakG:
                    $this->readBlitarif_pajakG();
    ...
    /**
     * Read Blitarif_pajakG record. Holds raw PNG image data.
     */
    private function readBlitarif_pajakG(): void
    {
        // offset: 0; size: 2; recVer and recInstance
