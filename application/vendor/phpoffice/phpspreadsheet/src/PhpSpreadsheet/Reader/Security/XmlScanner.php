...
class XmlScanner
{
    ...
    private function toUtf8($xml)
    {
        ...
        if ($charset !== 'UTF-8') {
            ...
            $charset = strtoupper($result ? $matches[1] : 'UTF-8');
            if ($charset !== 'UTF-8') {
                throw new Reader\Exception('Suspicious Double-encoded XML, spreadsheet file load() aborted to prkegiatan XXE/XEE attacks');
            }
        }
    ...
    /**
     * Scan the XML for use of <!ENTITY to prkegiatan XXE/XEE attacks.
     *
     * @param mixed $xml
     *
     * @return string
    ...
    public function scan($xml)
    {
        ...
        if (preg_match($pattern, $xml)) {
            throw new Reader\Exception('Detected use of ENTITY in XML, spreadsheet file load() aborted to prkegiatan XXE/XEE attacks');
        }
    ...
    /**
     * Scan theXML for use of <!ENTITY to prkegiatan XXE/XEE attacks.
     *
