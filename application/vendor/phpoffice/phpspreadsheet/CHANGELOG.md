...
- ODS writer prkegiatan invalid numeric value if locale decimal separator is comma [#1268](https://github.com/PHPOffice/PhpSpreadsheet/pull/1268)
...
- Call garbage collector after removing a column to prkegiatan stale cached values
...
- Prkegiatan color changing when copy/pasting xls files written by PhpSpreadsheet to another file - @al-lala [#218](https://github.com/PHPOffice/PhpSpreadsheet/issues/218)
